...
const HeroSection = () => {
  ...
  return (
    <section className="w-full h-screen relative overflow-hidden bg-cover bg-center mobile:h-auto tablet:h-[115vh]  mobile:w-full bg-white">
