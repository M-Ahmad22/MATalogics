...
const JobCard = ({ job, onApplyClick }) => (
  <div
   ...
   items-start border-[1.209px] border-[#DCDCDC] flex-col mb-[25px] relative mobile:w-[100%]"
  >
    ...
    <div
      className="w-[367px] h-[1.2px] bg-[#4C4C4C]/[0.17] mx-7 mt-5 mobile:hidden"
      style={{
    ...
    ></div>
    <div className="hidden mobile:flex justify-center w-full h-auto">
      <div
        className="w-[367px] h-[1.2px] bg-[#4C4C4C]/[0.17] mx-7 mt-5 mobile:w-[85%] mobile:mx-0 mobile:items-center"
        style={{
          WebkitTextStrokeWidth: "1px",
          WebkitTextStrokeColor: "#4C4C4C",
          paintOrder: "stroke fill",
    ...
    <div className="w-[57px] h-[24px] flex justify-center items-center gap-[6.137px] rounded-[22.609px] bg-[#F5F7F8] absolute top-[35px] right-[30px]">
