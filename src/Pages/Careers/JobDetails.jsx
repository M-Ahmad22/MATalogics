...
const JobDetails = () => {
  ...
  return (
    <>
      <section className="h-auto bg-[#F9F9F9] mobile:w-full">
        ...
        <div className="px-6 py-16 max-w-[1800px] mx-auto justify-center items-center w-full flex flex-col mobile:w-full mobile:h-auto">
          <div className="w-[1239px] h-[1153px]  bg-[#fff] border-[1px] border-[#DCDCDC] rounded-[20px] px-[80px] py-[70px] mobile:w-full mobile:h-auto mobile:px-3 mobile:py-8 ">
            <h1 className="font-outfit text-[32px] font-bold text-[#000] mb-4 leading-normal mobile:text-[28px] mobile:mb-2">
              {job.title}
            </h1>
            <h2 className=" font-montserrat text-[24px] font-normal text-[#000] mb-4 leading-[23px] mobile:text-[20px] mobile:mb-2 ">
            ...
            <h1 className=" font-outfit text-[25px] font-bold text-[#000] mb-4 leading-normal mt-12 mobile:text-[22px] mobile:mb-2 mobile:mt-6">
              Description
            </h1>
            <h2 className="font-montserrat text-[20px] font-normal text-[#000] leading-[37px] mobile:text-[17px] mobile:mb-2 mobile:mt-0 mobile:leading-[30px]">
              {job.description}
            </h2>
            ...
            {job.responsibilities && (
              <>
                ...
                <div className="font-montserrat text-[20px] font-normal text-[#000] leading-[44px] mobile:text-[16px] mobile:leading-[30px]">
