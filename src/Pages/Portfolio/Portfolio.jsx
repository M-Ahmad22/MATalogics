...
import PorfolioBg from "../../assets/PorfolioBg.png";
    ...
    <>
      <section className="h-auto bg-[#FFF] flex flex-col items-center justify-center mobile:h-auto ">
        <div className="relative w-full h-[450px] ">
          ...
          <div className="absolute inset-0  flex flex-col items-center justify-center text-center mobile:w-full ">
            <h1
              className="text-[#fff] font-outfit text-[54px] font-bold leading-[63px]  mb-3 mt-7"
              style={{
                leadingTrim: "both",
                textEdge: "cap",
                fontStyle: "normal",
          ...
          <div className="w-[90%] h-auto flex flex-col justify-center items-center  ">
            <div className="ServicesCards grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full px-1 py-[60px] mx-1 mobile:mx-0 mobile:px-0">
              {portfolioProjects.map((portfolioProjects, index) => (
                <div
                  className="group relative card h-[540px] w-[400px] bg-[#FFFFFF] mx-1 my-0 rounded-3xl border-[2px] border-[#EAECF0] mobile:mx-0 mobile:w-[100%]"
                  key={[index]}
                >
