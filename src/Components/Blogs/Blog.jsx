...
const Blog = () => {
  return (
    <section
      id="PortfolioSection"
      className="w-full h-[952px] bg-[#F8F8F9] flex justify-center items-center pt-[40px] pb-[30px] mobile:h-auto "
    >
      <div className="h-[auto] w-[72%] flex flex-col relative justify-center items-center mobile:w-full">
        ...
        <div className="BlogCards w-[100%] h-[600px] flex justify-center items-center mt-[40px] mobile:flex-col mobile:h-auto ">
          ...
          <div className="relative RightCard h-[95.5%] w-[575px] flex flex-col justify-center items-center  mx-1 my-1 rounded-[8.825px] mobile:w-[66%] mobile:h-auto mobile:flex-col ">
            <img
              src={BlogThree}
              alt=""
              className="inset-0 w-full h-full object-cover z-10  rounded-[8.825px]"
            />
            <div className="absolute bottom-0 right-0  w-[271.512px] h-[278.131px] flex flex-col justify-center items-center border-[1px] border-[#D0D5DD] rounded-[8.825px] bg-[#fff] z-30 mobile:w-[50%] mobile:h-[50%] mobile:bottom-[9.6%] mobile:right-[10%] mobile:z-10 transform scale-[0.70]">
              {BlogData.map((item, index) => {
