...
const WhyChooseUs = () => {
  return (
    <section
      id="whyChooseUs"
      className="relative w-full h-[385.9932px] bg-[#06142A] my-16 mobile:h-[850px] mobile:w-[100%] "
    >
      <div className="Lines w-[90%] z-20 mobile:w-[90%] ">
        <img
          src={Line1}
          alt=""
          className="w-[1985.323px]  h-[166.295px] rotate-[0] z-20 object-center "
        />
        <img
          src={Line2}
          alt=""
          className="w-[2197.98px]  h-[230.05px] z-20 object-center mobile:mt-[50px]"
        />
        <img
          src={Line2}
          alt=""
          className="w-[2197.98px] hidden  h-[230.05px] z-20 object-center mobile:block mobile:mt-[80px] mobile:rotate-[130deg]"
        />
      </div>
      <div className="absolute inset-0 top-0 left-0 w-full h-full flex justify-center items-center mobile:flex-col  ">
        <div className="TextWhyUs flex flex-col w-[340px] align-items-start mobile:w-[90%] ">
        ...
        <div className="Features d-inline-flex items-center gap-[24px] mx-[100px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mobile:mt-[70px] mobile:mx-0">
          {features.map((features, index) => (
            <div
              className="CardWhyUs w-[316px] h-[117px] flex-shrink-0 border-[0.4px] border-[#FFFFFF] rounded-2xl bg-[#FFFFFF]/[5%] px-5 py-5"
              key={index}
            >
