...
const ServicesSection = () => {
  return (
    <section
      id="services"
      className="w-full h-[130vh] bg-[#FFFFFF] flex justify-center items-center mt-[120px] mobile:h-auto mobile:mt-[40px]"
    >
          ...
          {services.map((service, index) => {
            ...
            if (isLastCard) {
              return (
                <div
                  key={index}
                  className="group relative h-[500px] w-[400px] bg-[#1E1D28] text-white mx-1 my-0 rounded-3xl flex flex-col border-[#EAECF0] justify-center p-8 hover mobile:w-[100%] mobile:mx-0"
                >
            ...
            return (
              <div className="group relative card h-[500px] w-[400px] bg-[#FFFFFF] mx-1 my-0 rounded-3xl border-[2px] border-[#EAECF0] mobile:w-[100%] mobile:mx-0">
