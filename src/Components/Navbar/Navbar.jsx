  ...
  return (
    ...
    >
      <div className="max-w-[full] mx-auto px-[150px] py-[20px] flex items-center justify-between mobile:px-3">
        ...
        <nav className="hidden md:flex space-x-9 text-lg font-medium text-[white] font-outfit">
        ...
        <div className="md:hidden mr-4">
          <button
            className="md:hidden text-[#fff] text-2xl"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden px-4 pt-4 pb-6 bg-[#1E1D288C]/55 backdrop-blur-sm shadow-md text-[#fff] flex flex-col gap-6 font-outfit items-center">
