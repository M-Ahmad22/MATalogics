  ...
  return (
    <footer className="bg-[#1E1D28] w-full flex-shrink-0 flex justify-center items-center  mobile:px-[20px]">
      <div className="w-[100%] sm:w-[80%] flex flex-col items-center">
        <div className="sm:w-[80%] flex flex-col sm:flex-row justify-between items-start my-[62px] gap-[30px] sm:gap-0">
          <div className="h-[188px] w-full sm:w-[248px] flex flex-col justify-between relative mobile:h-auto">
            <div className="flex items-center mb-4 mobile:mb-[30px]">
              <img
                src={MainLogo}
                alt="logo"
            ...
            <h2 className="text-[#fff] font-montserrat text-[14px] font-normal leading-[22.88px] mobile:text-justify">
              Empowering businesses with cutting-edge web, mobile, and AI
              solutions crafted with logic and precision.
            </h2>
          </div>

          <div className="h-[188px] w-full sm:w-[248px] flex flex-col justify-between items-start">
          ...
          <div className="h-[188px] w-full sm:w-[248px] flex flex-col items-start">
            <h1 className="text-[#fff] font-montserrat text-[18px] font-bold leading-[21.68px] pt-[14px] tracking-[0.5px]">
              Contact
            </h1>
          ...
          <div className="h-[188px] w-full sm:w-[358px] flex flex-col items-start">
            ...
            <div className="flex w-full sm:w-[348px] h-[44px] items-center justify-between rounded-[775.266px] border-[0.776px] border-[#C9CDD2] bg-[#FFF] mt-4 px-3 mobile:pr-1">
              <input
                type="email"
                className="flex-grow font-inter text-[12.417px] font-normal leading-[18.625px] outline-none"
        ...
        <div className="w-full sm:w-[80%] flex flex-col sm:flex-row justify-between items-center gap-4 mb-9">
          ...
          <div className="flex items-center gap-[10.588px]">
            {links.map((item, index) => (
              <div
                key={index}
                className="w-[27.53px] h-[27.53px] rounded-[52.412px] bg-[#F1F2F4] flex justify-center items-center"
              >
                <img
                  src={item.icon}
                  alt=""
