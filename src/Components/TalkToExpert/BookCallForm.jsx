...
const BookCallForm = () => {
  ...
  return (
    <>
      <div className="w-full h-full flex items-start border border-gray-200 rounded-lg mobile:w-full mobile:h-[175vh] mobile:flex-col mobile:items-center">
        {/* Profile Section */}
        <div className=" text-[#1A2A4D] p-12  text-center h-full w-[35%] mobile:w-[95%] mobile:h-auto ">
          ...
          <div className="Timer mt-[80px] flex justify-start items-center w-full h-auto mb-8 mobile:mt-8">
            <img src={Timer} alt="" />
        ...
        <div className="w-[2px] h-full bg-[#E5E7EB] mobile:hidden"></div>

        {/* Calendar Section */}
        <div className="w-[2px] bg-gray-200 mobile:hidden"></div>
        <div className="h-[600px] w-[50%] flex items-center justify-center p-4 mobile:h-[auto] mobile:w-[70%] mobile:my-[30px]">
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DateCalendar
              value={selectedDate}
              onChange={(newValue) => setSelectedDate(newValue)}
              disablePast
              className="scale-[1.5] mobile:scale-[1.2]"
            />
        ...
        <div className="p-8 w-[35%] mobile:h-auto mobile:w-full">
          <form className="space-y-6 mobile:relative mobile:h-auto">
            {step === 1 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-2 overflow-y-auto overflow-x-hidden max-h-[500px] scrollbar-hide scroll-smooth mt-2 mobile:h-[350px]">
            ...
            {step === 3 && (
              <motion.div
                ...
                transition={{ duration: 0.4 }}
              >
                <div className="text-center justify-center w-full h-[600px] flex flex-col items-center">
                  ...
                  <div className=" text-[#4B5563] font-montserrat text-[15px] font-medium leading-[22.435px] rounded-lg w-[100%] text-left mb-[70px] flex flex-col gap-1 mobile:mb-[190px]">
            ...
            <div className="absolute bottom-[40px] flex gap-[115px] mobile:bottom-[-100px] mobile:w-full mobile:h-auto  mobile:justify-between] ">
              {step > 1 && step < 3 && (
                <button
                  type="button"
                  onClick={handlePrev}
                  className="w-[120px] h-[44px] flex justify-center items-center rounded-[10px] bg-[#0045E6] text-[#FFF] text-center text-[14px] font-medium font-outfit leading-[20px] capitalize "
                >
                  Back
                </button>
              )}
              {step === 2 && (
                <button
                  ...
                  className={`px-6 py-2 rounded-md font-semibold transition ${
                    isFormValid
                      ? "w-[120px] h-[44px] flex justify-center items-center rounded-[10px] bg-[#0045E6] text-[#FFF] text-center text-[14px] font-medium font-outfit leading-[20px] capitalize"
                      : "w-[120px] h-[44px] flex justify-center items-center rounded-[10px] bg-[#0045E6] text-[#FFF] text-center text-[14px] font-medium font-outfit leading-[20px] capitalize cursor-not-allowed"
                  }`}
                >
                  Submit →
                </button>
