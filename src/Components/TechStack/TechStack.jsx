...
const TechStack = () => {
  ...
  return (
    <section
      id="tech"
      className="flex flex-col justify-center items-center gap-[61px] my-[100px] w-full h-[558px] mobile:h-auto "
    >
      <div className="TechStackTitle gap-[12px] h-auto w-[576px] flex flex-col justify-center items-center mobile:w-full ">
     ...
     flex-wrap 
     md:flex-nowrap md:h-[77px] md:gap-[28px] mobile:rounded-[20px] mobile-w[90%] mobile:h-[200px] mobile:py-6"
        >
        ...
        <div className="h-[200px] w-[870px] flex flex-wrap justify-center items-center gap-[43px] mobile:w-full mobile:h-auto ">
